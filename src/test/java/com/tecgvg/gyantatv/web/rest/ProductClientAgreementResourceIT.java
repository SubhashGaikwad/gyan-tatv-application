...
class ProductClientAgreementResourceIT {
    ...
    private static final Double DEFAULT_PENALTY = 1D;
    private static final Double UPDATED_PENALTY = 2D;
    private static final Double SMALLER_PENALTY = 1D - 1D;
    ...
    private static final Double DEFAULT_AGREEMENT_PERIOD = 1D;
    private static final Double UPDATED_AGREEMENT_PERIOD = 2D;
    private static final Double SMALLER_AGREEMENT_PERIOD = 1D - 1D;
    ...
    void createProductClientAgreement() throws Exception {
        ...
        assertThat(testProductClientAgreement.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
    ...
    void getAllProductClientAgreements() throws Exception {
        ...
        restProductClientAgreementMockMvc
            ...
            .andExpect(jsonPath("$.[*].penalty").value(hasItem(DEFAULT_PENALTY.doubleValue())))
            .andExpect(jsonPath("$.[*].penaltyTerms").value(hasItem(DEFAULT_PENALTY_TERMS.toString())))
            .andExpect(jsonPath("$.[*].notes").value(hasItem(DEFAULT_NOTES)))
            .andExpect(jsonPath("$.[*].image").value(hasItem(DEFAULT_IMAGE)))
            .andExpect(jsonPath("$.[*].agreementPeriod").value(hasItem(DEFAULT_AGREEMENT_PERIOD.doubleValue())))
    ...
    void getProductClientAgreement() throws Exception {
        ...
        restProductClientAgreementMockMvc
            ...
            .andExpect(jsonPath("$.penalty").value(DEFAULT_PENALTY.doubleValue()))
            .andExpect(jsonPath("$.penaltyTerms").value(DEFAULT_PENALTY_TERMS.toString()))
            .andExpect(jsonPath("$.notes").value(DEFAULT_NOTES))
            .andExpect(jsonPath("$.image").value(DEFAULT_IMAGE))
            .andExpect(jsonPath("$.agreementPeriod").value(DEFAULT_AGREEMENT_PERIOD.doubleValue()))
    ...
    @Test
    @Transactional
    void getAllProductClientAgreementsByDescriptionIsEqualToSomething() throws Exception {
        // Initialize the database
        productClientAgreementRepository.saveAndFlush(productClientAgreement);

        // Get all the productClientAgreementList where description equals to DEFAULT_DESCRIPTION
        defaultProductClientAgreementShouldBeFound("description.equals=" + DEFAULT_DESCRIPTION);

        // Get all the productClientAgreementList where description equals to UPDATED_DESCRIPTION
        defaultProductClientAgreementShouldNotBeFound("description.equals=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    void getAllProductClientAgreementsByDescriptionIsNotEqualToSomething() throws Exception {
        // Initialize the database
        productClientAgreementRepository.saveAndFlush(productClientAgreement);

        // Get all the productClientAgreementList where description not equals to DEFAULT_DESCRIPTION
        defaultProductClientAgreementShouldNotBeFound("description.notEquals=" + DEFAULT_DESCRIPTION);

        // Get all the productClientAgreementList where description not equals to UPDATED_DESCRIPTION
        defaultProductClientAgreementShouldBeFound("description.notEquals=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    void getAllProductClientAgreementsByDescriptionIsInShouldWork() throws Exception {
        // Initialize the database
        productClientAgreementRepository.saveAndFlush(productClientAgreement);

        // Get all the productClientAgreementList where description in DEFAULT_DESCRIPTION or UPDATED_DESCRIPTION
        defaultProductClientAgreementShouldBeFound("description.in=" + DEFAULT_DESCRIPTION + "," + UPDATED_DESCRIPTION);

        // Get all the productClientAgreementList where description equals to UPDATED_DESCRIPTION
        defaultProductClientAgreementShouldNotBeFound("description.in=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    void getAllProductClientAgreementsByDescriptionIsNullOrNotNull() throws Exception {
        // Initialize the database
        productClientAgreementRepository.saveAndFlush(productClientAgreement);

        // Get all the productClientAgreementList where description is not null
        defaultProductClientAgreementShouldBeFound("description.specified=true");

        // Get all the productClientAgreementList where description is null
        defaultProductClientAgreementShouldNotBeFound("description.specified=false");
    }

    @Test
    @Transactional
    void getAllProductClientAgreementsByDescriptionContainsSomething() throws Exception {
        // Initialize the database
        productClientAgreementRepository.saveAndFlush(productClientAgreement);

        // Get all the productClientAgreementList where description contains DEFAULT_DESCRIPTION
        defaultProductClientAgreementShouldBeFound("description.contains=" + DEFAULT_DESCRIPTION);

        // Get all the productClientAgreementList where description contains UPDATED_DESCRIPTION
        defaultProductClientAgreementShouldNotBeFound("description.contains=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    void getAllProductClientAgreementsByDescriptionNotContainsSomething() throws Exception {
        // Initialize the database
        productClientAgreementRepository.saveAndFlush(productClientAgreement);

        // Get all the productClientAgreementList where description does not contain DEFAULT_DESCRIPTION
        defaultProductClientAgreementShouldNotBeFound("description.doesNotContain=" + DEFAULT_DESCRIPTION);

        // Get all the productClientAgreementList where description does not contain UPDATED_DESCRIPTION
        defaultProductClientAgreementShouldBeFound("description.doesNotContain=" + UPDATED_DESCRIPTION);
    }
    ...
    @Test
    @Transactional
    void getAllProductClientAgreementsByProductIsEqualToSomething() throws Exception {
        // Initialize the database
        productClientAgreementRepository.saveAndFlush(productClientAgreement);
        Product product;
        ...
        em.persist(product);
        em.flush();
        productClientAgreement.setProduct(product);
        productClientAgreementRepository.saveAndFlush(productClientAgreement);
        Long productId = product.getId();

        // Get all the productClientAgreementList where product equals to productId
        defaultProductClientAgreementShouldBeFound("productId.equals=" + productId);

        // Get all the productClientAgreementList where product equals to (productId + 1)
        defaultProductClientAgreementShouldNotBeFound("productId.equals=" + (productId + 1));
    }

    @Test
    @Transactional
    void getAllProductClientAgreementsByClientDetailsIsEqualToSomething() throws Exception {
        // Initialize the database
        productClientAgreementRepository.saveAndFlush(productClientAgreement);
        ...
        em.persist(clientDetails);
        em.flush();
        productClientAgreement.setClientDetails(clientDetails);
        productClientAgreementRepository.saveAndFlush(productClientAgreement);
        Long clientDetailsId = clientDetails.getId();

        // Get all the productClientAgreementList where clientDetails equals to clientDetailsId
        defaultProductClientAgreementShouldBeFound("clientDetailsId.equals=" + clientDetailsId);

        // Get all the productClientAgreementList where clientDetails equals to (clientDetailsId + 1)
        defaultProductClientAgreementShouldNotBeFound("clientDetailsId.equals=" + (clientDetailsId + 1));
    }
    ...
    void putNewProductClientAgreement() throws Exception {
        ...
        assertThat(testProductClientAgreement.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
