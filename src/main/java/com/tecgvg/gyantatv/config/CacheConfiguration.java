...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.tecgvg.gyantatv.domain.Product.class.getName() + ".productClientAgreements");
            ...
            createCache(cm, com.tecgvg.gyantatv.domain.ClientDetails.class.getName() + ".productClientAgreements");
            createCache(cm, com.tecgvg.gyantatv.domain.State.class.getName());
            createCache(cm, com.tecgvg.gyantatv.domain.District.class.getName());
