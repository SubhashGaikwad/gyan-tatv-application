...
import com.tecgvg.gyantatv.service.ParameterLookupQueryService;
import com.tecgvg.gyantatv.service.ParameterLookupService;
...
/**
 * REST controller for managing {@link com.tecgvg.gyantatv.domain.ParameterLookup}.
 */
@RestController
@RequestMapping("/api")
public class ParameterLookupResource {
    ...
    public ResponseEntity<ParameterLookupDTO> createParameterLookup(@RequestBody ParameterLookupDTO parameterLookupDTO)
    ...
    public ResponseEntity<ParameterLookupDTO> updateParameterLookup(
        ...
        @RequestBody ParameterLookupDTO parameterLookupDTO
    ) throws URISyntaxException {
        ...
        ParameterLookupDTO result = parameterLookupService.update(parameterLookupDTO);
        return ResponseEntity
            .ok()
