...
public class Product implements Serializable {
    ...
    public void setProductClientAgreements(Set<ProductClientAgreement> productClientAgreements) {
        if (this.productClientAgreements != null) {
            this.productClientAgreements.forEach(i -> i.setProduct(null));
        }
        if (productClientAgreements != null) {
            productClientAgreements.forEach(i -> i.setProduct(this));
        }
        this.productClientAgreements = productClientAgreements;
    }

    public Product productClientAgreements(Set<ProductClientAgreement> productClientAgreements) {
        this.setProductClientAgreements(productClientAgreements);
        return this;
    }

    public Product addProductClientAgreement(ProductClientAgreement productClientAgreement) {
        this.productClientAgreements.add(productClientAgreement);
        productClientAgreement.setProduct(this);
        return this;
    }

    public Product removeProductClientAgreement(ProductClientAgreement productClientAgreement) {
        this.productClientAgreements.remove(productClientAgreement);
        productClientAgreement.setProduct(null);
        return this;
    }
