...
public class District implements Serializable {
    ...
    public District lastModified(Instant lastModified) {
    ...
    public District lastModifiedBy(String lastModifiedBy) {
    ...
    public void setClientDetails(ClientDetails clientDetails) {
        if (this.clientDetails != null) {
            this.clientDetails.setDistrict(null);
        }
        if (clientDetails != null) {
            clientDetails.setDistrict(this);
        }
        this.clientDetails = clientDetails;
    }

    public District clientDetails(ClientDetails clientDetails) {
