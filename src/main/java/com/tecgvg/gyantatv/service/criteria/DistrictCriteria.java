...
/**
 * Criteria class for the {@link com.tecgvg.gyantatv.domain.District} entity. This class is used
 * in {@link com.tecgvg.gyantatv.web.rest.DistrictResource} to receive all the possible filtering options from
...
public class DistrictCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, deleted, lgdCode, lastModified, lastModifiedBy, stateId, clientDetailsId, distinct);
    }
