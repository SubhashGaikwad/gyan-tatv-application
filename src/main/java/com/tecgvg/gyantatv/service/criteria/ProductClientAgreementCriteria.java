...
public class ProductClientAgreementCriteria implements Serializable, Criteria {
    ...
    private LongFilter agreementPeriod;
    ...
    public LongFilter getPenalty() {
        return penalty;
    }

    public LongFilter penalty() {
        if (penalty == null) {
            penalty = new LongFilter();
        }
        return penalty;
    }

    public void setPenalty(LongFilter penalty) {
    ...
    public LongFilter getAgreementPeriod() {
        return agreementPeriod;
    }

    public LongFilter agreementPeriod() {
        if (agreementPeriod == null) {
            agreementPeriod = new LongFilter();
        }
        return agreementPeriod;
    }

    public void setAgreementPeriod(LongFilter agreementPeriod) {
