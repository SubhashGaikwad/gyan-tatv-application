...
export class ClientDetailsComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.clientDetailsService
      ...
      .subscribe({
        next: (res: HttpResponse<IClientDetails[]>) => {
  ...
  trackId(_index: number, item: IClientDetails): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IClientDetails[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
